...
############
# LED-base, 2048 input (-ATS, + binary blanks) using max [SUMMARIZE] likelihood
############
executable = nllp_postprocess_evaluate.sh
getenv = true
environment = "CLUSTER_ID=$(Cluster); PROCESS_ID=$(Process);"
...
--checkpoint /home2/jcmw614/ling573/models/led-base/billsum_clean_train_se3-led-2048-512/binary_blank_targets/2048_512_5_epochs/checkpoint-45220/ \
--k_selector [SUMMARIZE] --k_limit 2 --batch_size 8
transfer_executable = false
output = postprocess_empties.$(Cluster).$(Process).out
error = postprocess_empties.$(Cluster).$(Process).err
log = postprocess_empties.$(Cluster).$(Process).log
...
############
# LED-base, 2048 input (-ATS, + binary blanks) using random k chunks
############
executable = nllp_postprocess_evaluate.sh
getenv = true
environment = "CLUSTER_ID=$(Cluster); PROCESS_ID=$(Process);"
...
getenv = true
environment = "CLUSTER_ID=$(Cluster); PROCESS_ID=$(Process);"
arguments = --config_id 4 --new_config_id 9 --base_tokenizer allenai/led-base-16384 \
...
--k_selector [NO_SUMMARY] --k_limit 3 --batch_size 8
transfer_executable = false
output = postprocess_empties.$(Cluster).$(Process).out
error = postprocess_empties.$(Cluster).$(Process).err
log = postprocess_empties.$(Cluster).$(Process).log
...
############
# LED-base, 1024 input (-ATS, + binary blanks) using max [SUMMARIZE] likelihood
############
executable = nllp_postprocess_evaluate.sh
getenv = true
environment = "CLUSTER_ID=$(Cluster); PROCESS_ID=$(Process);"
arguments = --config_id 4 --new_config_id 10 --base_tokenizer allenai/led-base-16384 \
--checkpoint /home2/jcmw614/ling573/models/led-base/billsum_clean_train_se3-led-1024-512/binary_blank_targets/1024_512_5_epochs/checkpoint-108471/ \
--k_selector [SUMMARIZE] --k_limit 3 --batch_size 8
transfer_executable = false
output = postprocess_empties.$(Cluster).$(Process).out
error = postprocess_empties.$(Cluster).$(Process).err
log = postprocess_empties.$(Cluster).$(Process).log
...
############
# LED-base, 1024 input (-ATS, + binary blanks) using random k chunks
############
executable = nllp_postprocess_evaluate.sh
getenv = true
environment = "CLUSTER_ID=$(Cluster); PROCESS_ID=$(Process);"
arguments = --config_id 4 --new_config_id 11 --base_tokenizer allenai/led-base-16384 \
--checkpoint /home2/jcmw614/ling573/models/led-base/billsum_clean_train_se3-led-1024-512/binary_blank_targets/1024_512_5_epochs/checkpoint-108471/ \
--k_limit 2 --batch_size 8
transfer_executable = false
output = postprocess_empties.$(Cluster).$(Process).out
